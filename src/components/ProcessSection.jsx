  ...
  const steps = [
    {
      ...
      description: 'We source quality sugarcane from farms in and around Dhampur.',
    ...
    },
    {
      ...
      description: 'The juice is filtered and slowly boiled using traditional methods.',
    ...
    },
    {
      num: '4',
      title: 'Thickening',
      description: 'The juice is cooked to the right consistency with care and experience.',
    ...
    },
    {
      ...
      description: 'We pack the jaggery hygienically so it reaches your home fresh.',
      ...
      <div className="container">
        ...
        <div className="section-header">
          <div className="section-title-wrap">
            ...
            <p className="section-subtitle">From Sugarcane to Jaggery – A Journey of Purity</p>
          </div>
          <button
